...
Widget defaultFormField({
  ...
  Function? onTap,
    ...
    TextFormField(
      ...
      enableInteractiveSelection: interactiveSelection, // this used to disable paste and select all in text form field
    );
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            //      ),
              CircleAvatar(
                backgroundColor: Color(0xFFA6947A),
                radius: 40.0,
                child: Text(
                  '${model['time']}',
                  style: TextStyle(
